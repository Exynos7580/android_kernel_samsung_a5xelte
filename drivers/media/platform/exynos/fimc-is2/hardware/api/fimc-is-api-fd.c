...
int fimc_is_lib_fd_load_setfile(struct fimc_is_lib *fd_lib, ulong setfile_addr)
{
	...
	if (header_v3->magic_number < FD_SET_FILE_MAGIC_NUMBER) {
		...
		lib_data->setfile.version = SETFILE_V2;
		...
		lib_data->setfile.version = SETFILE_V3;
...
int fimc_is_lib_fd_apply_setfile(struct fimc_is_lib *fd_lib, struct vra_param *fd_param)
{
	...
	if ((fd_data->setfile.version == SETFILE_V2) || (fd_data->setfile.version == SETFILE_V3)) {
		...
		u32 hw_width, u32 hw_height)
{
	...
	u32 width_5_3 = 5, height_5_3 = 3, width_3_2 = 3, height_3_2 = 2;
	struct fimc_is_lib_fd *fd_data = NULL;
	...
	if ((preview->width / width_4_3) == (preview->height / height_4_3)
			|| (preview->width / width_3_2) == (preview->height / height_3_2)) {
		lib_input->map_width = 640;
		lib_input->map_height = 480;
	} else if ((preview->width / width_16_9) == (preview->height / height_16_9)
			|| (preview->width / width_5_3) == (preview->height / height_5_3)) {
		lib_input->map_width = 640;
		lib_input->map_height = 360;
	} else {
		/* support 1:1, 11:9 size ratio */
